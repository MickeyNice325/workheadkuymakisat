    ...
    <div class="container mt-3">
        ...
        <form action="">
            <div class='d-flex justify-content-center mb-3'>
                ...
                <input type="text" name='m_user' id='m_user' class="form-control w-25 ">
                <button tpye='submit' class="btn btn-primary ms-2">ตกลง</button>
            </div>
            <div class='d-flex justify-content-center'>
                <label for="">รหัสหนังสือ</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" name='b_id' id='b_id' class="form-control w-25">
                <button tpye='submit' class="btn btn-primary ms-2">ตกลง</button>
            </div>
        </form>
    </div>
